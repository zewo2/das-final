...
Após concluir o relatório e fazer as cinco (5) alterações e commits necessários, foi criada uma release:
...
git flow release finish Rel-1.0 -m "v1"
...
git flow hotfix finish Rel-1.1
